...
When defining a currency it can be mapped to an ERC-20 1:1. The currency on Verus and the ERC-20 on Ethereum are then always interchangeable 1 to 1. [More on the Verus-Ethereum Bridge.](/eth-bridge/)
...
### Export to Ethereum
The last step is to export the currency to Ethereum so we can see it there too. [👉 Read it here](/currencies/export-to-eth/)
